...
namespace ETAB_Automation
{
    ...
    public partial class ImportConfigForm
    {
        ...
        private void InitializeBuildingConfigTab(TabPage tab)
        {
            ...
            // Basement
            var grpBasement = AddGroupBox(tab, "Basement Floors", 20, y, 820, 90);
            chkBasement = AddCheckBox(grpBasement, "Include Basement Floors", 20, 25);
            chkBasement.CheckedChanged += ChkBasement_CheckedChanged;
            AddLabel(grpBasement, "Number of Basements:", 40, 52);
            numBasementLevels = AddNumeric(grpBasement, 200, 50, 1, 10, 2, enabled: false);
            AddLabel(grpBasement, "Basement Height (m):", 320, 52);
            numBasementHeight = AddNumeric(grpBasement, 480, 50, 2.5M, 6.0M, 3.5M, 
